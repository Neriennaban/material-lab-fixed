...
STRUCTURE_STAGE_LABELS_RU: dict[str, str] = {
    ...
    "bainite": "Бейнит",
    "bainite_upper": "Верхний бейнит",
    "bainite_lower": "Нижний бейнит",
    "carbide_free_bainite": "Безкарбидный бейнит",
    "widmanstatten_ferrite": "Видманштеттов феррит",
    "decarburized_layer": "Обезуглероженный слой",
    "carburized_layer": "Цементированный слой",
    "granular_pearlite": "Зернистый перлит",
